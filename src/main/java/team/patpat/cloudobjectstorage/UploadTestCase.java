...
public class UploadTestCase {
     ...
     * @return 成功返回1，失败返回-1。
     */
    public int uploadTestCase(String localFilePath, String courseName) {
        int testName = -1;
        testName = getTestNumber(courseName);
        updateTestCase(localFilePath, courseName, String.valueOf(testName));
        if (testName == -1) {
            return -1;
        }
        return 1;
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                if (currentIteration.equals(iteration)) {
                    ...
                    updateStatement.setInt(1, currentNumber + 1);
